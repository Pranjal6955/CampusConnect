      ...
      <View className="flex-1 items-center justify-center px-6" style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
        ...
        >
          ...
          <View className="items-center mb-4">
            ...
            >
              <Ionicons name={explanation.icon as any} size={32} color="#0EA5E9" />
            </View>
          </View>

          {/* Title */}
          <Text className={`text-xl font-bold text-center mb-3 ${isDark ? "text-white" : "text-gray-900"}`}>
            {explanation.title}
          </Text>

          {/* Description */}
          <Text className={`text-base text-center mb-6 leading-6 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
