    ...
    <View className={`flex-1 ${isDark ? 'bg-black' : 'bg-gray-50'}`}>
      ...
      >
        ...
        <View className="mb-6">
          ...
          <Text
            className={`text-base leading-6 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}
          >
            Welcome to CampusConnect. We are committed to protecting your
            privacy and ensuring transparency about how we collect, use, and
            protect your personal information. This Privacy Policy explains our
        ...
        <View className="mb-6">
          ...
          <Text
            className={`text-base leading-6 mb-3 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}
          >
            We collect the following types of information:
          </Text>

          <View
            className={`p-4 rounded-2xl mb-3 ${isDark ? 'bg-gray-900' : 'bg-white'}`}
          >
            <Text
          ...
          >
            ...
            >
              ...
              (only if you grant permission, optional)
            </Text>
          </View>
        ...
        <View className="mb-6">
          ...
          >
            ...
            >
              ...
              you event notifications and reminders{'\n'}• Track event
        ...
        <View className="mb-6">
          ...
          >
            ...
            >
              ...
              Cloudinary with secure access controls{'\n'}• We implement
              authentication and authorization measures{'\n'}• Regular security
              audits and updates are performed{'\n'}• Access to data is limited
        ...
        <View className="mb-6">
          ...
          >
            <Text
              className={`text-sm leading-5 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}
            >
              • <Text className="font-semibold">View Data:</Text> Access your
              personal information through your profile settings{'\n'}•{' '}
              <Text className="font-semibold">Update Data:</Text> Edit your
              profile information at any time{'\n'}•{' '}
              <Text className="font-semibold">Delete Data:</Text> Request
              account deletion by contacting us{'\n'}•{' '}
              <Text className="font-semibold">Opt-Out:</Text> Disable
              notifications in app settings{'\n'}•{' '}
              <Text className="font-semibold">Data Export:</Text> Request a copy
              of your data{'\n'}•{' '}
              <Text className="font-semibold">Withdraw Consent:</Text> Revoke
        ...
        <View className="mb-6">
          ...
          >
            ...
            needed to provide services. When you delete your account, we will
        ...
        <View className="mb-6">
          ...
          <Text
            className={`text-base leading-6 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}
          >
            CampusConnect is intended for college students and organizers. We do
