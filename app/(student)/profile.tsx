  ...
  return (
    <View className={`flex-1 ${isDark ? 'bg-black' : 'bg-gray-50'}`}>
      ...
      >
        ...
        {/* Appearance Section */}
        <Text
          className={`text-sm font-bold uppercase tracking-wider mb-4 ml-2 ${
        ...
        <View
          className={`flex-row mb-8 p-1.5 rounded-2xl ${isDark ? 'bg-gray-900' : 'bg-gray-100'}`}
          style={{
            shadowColor: '#000',
            shadowOffset: { width: 0, height: 2 },
            shadowOpacity: 0.05,
        ...
        <Text
          className={`text-sm font-bold uppercase tracking-wider mb-4 ml-2 mt-6 ${
            isDark ? 'text-gray-500' : 'text-gray-400'
          }`}
        >
          Legal & Support
