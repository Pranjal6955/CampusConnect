...
import { deleteEvent, Event, getEvent, getEventAttendance, markAttendance } from "../../../utils/events";
...
export default function OrganizerEventDetails() {
  ...
  const loadParticipants = async (participantIds: string[], eventId: string) => {
