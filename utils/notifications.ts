...
export async function scheduleLocalNotification(
  ...
  try {
    ...
    if (!enabled) {
      console.log(
        'Notifications disabled for user, skipping scheduled notification'
      );
      return null;
    }
...
export async function notifyEventAnnouncement(
  ...
  try {
    ...
    console.log(
      `Event announcement notification sent for event: ${event.title}`
    );
  } catch (error) {
...
export async function scheduleEventReminders(
  ...
  try {
    ...
    const now = new Date();
    // Calculate time until event (for potential future use)
...
export async function notifyEventUpdate(
  ...
  try {
    // Get all registered participants (for potential future use)
 ...
 */
export async function notifyLowSeats(
  event: Event,
  userId?: string
): Promise<void> {
  try {
 ...
 */
export async function schedulePostEventFeedback(
  event: Event,
  studentId: string
): Promise<void> {
  try {
 ...
 */
export async function notifyOrganizerLowAttendance(
  event: Event,
  organizerId: string
): Promise<void> {
  try {
    ...
    console.error(
      'Error sending organizer low attendance notification:',
      error
    );
  }
}
 ...
 */
export async function notifyOrganizerSoldOut(
  event: Event,
  organizerId: string
): Promise<void> {
  try {
 ...
 */
export async function notifyEventSuggestion(
  event: Event,
  studentId: string
): Promise<void> {
  try {
 ...
 */
export async function notifyCampusAlert(
  title: string,
  body: string,
  userId?: string
): Promise<void> {
